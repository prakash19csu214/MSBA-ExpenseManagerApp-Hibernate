	...
	<div id="add">
		...
		<form action="ExpenseController" method="GET">
			<table class="table">
				<tr class="form-group">
					<td>Name </td>
					<td><input type="text" class="form-control" placeholder="Expense Name" name="name"></td>
				</tr>
				<tr class="form-group">
					<td>Description</td>
					<td><input type="text" class="form-control" placeholder="Expense Description" name="descp"></td>
				</tr>
				<tr class="form-group">
					<td>Cost</td>
					<td><input type="text" class="form-control" placeholder="Expense Cost" name="cost"></td>
				</tr>
		...
		<div>
		<button class="btn btn-success" type="submit" name="addExpense" value="Add">Add Expense</button>
		<button class="btn btn-primary" type="submit" formmethod="post" name="showExpense" value="Show">Show Expense</button>
		</div>
		</form>
	</div>
    <div class="mt-3">
